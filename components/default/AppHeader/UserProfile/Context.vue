		...
		<div id="profile-context" class="context">
			<div class="context-container">
				...
				<div v-if="user" class="profile-data">
					<div class="profile-data-container" @click="onBtnClick('profile' , user)">
						<div class="profile-image-container pointer_arrow">
							<app-lazy-image
						...
						<div class="profile-info pointer_arrow">
					...
					<div class="profile-manual">
						<!-- General manual -->
						<div class="manual-item pointer_arrow" @click="onBtnClick('profile', user)">
						...
						<div class="manual-item pointer_arrow" @click="onBtnClick('help')">
						...
						<div class="manual-item pointer_arrow" @click="onBtnClick('privacy')">
...
export default {
	...
	computed: {
		...
		userAvatar () {
			...
			try {
				avatar = useStore().user.avatar || this.DefaultUserAvatar;
			}
			catch (error) {
