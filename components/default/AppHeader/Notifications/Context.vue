			...
			<div class="context-container">
				...
				<div v-if="notifications.length > 0" class="notification-list">
					...
					<div 
						...
						@click="notificationClickHandller(notification)"
					>
						<!-- Notification badge
						<div class="symbol">
							<app-icon-button 
						...
						<div class="symbol">
							<a class="app-icon-button primary-hoverable-icon tooltip filled error small">
...
export default {
	...
	methods: {
		...
		handleClearNotificationAction ($event) {
			this.$axios.$get('/api/v1/evolve/updateNotifications/0').catch ((error) => {});
			this.$emit('clearall', $event);
		},
		notificationClickHandller (data){
			
		     this.$axios.$get('/api/v1/evolve/updateNotifications/'+data._id).catch ((error) => {});
